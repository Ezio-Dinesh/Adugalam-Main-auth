...
<div
  className="love-sports-section"
>
  <div className="love-sports-overlay">
    <div className="love-sports-glass">
      <h2 class="wh">#i love sports</h2>
      <p class="wh">craft with love and support</p>
    </div>
  </div>
</div>
